...
test_df = pd.read_csv('/home/maantonov_1/VKR/data/main_data/test/test_main.csv')


test_dataset = LLAD(test_df, DIR_TRAIN, mode = "train", smart_crop = True, gaus = False, class_mask=False, new_shape = (640, 640), transforms = T.Compose([Normalizer(), ToTorch()]))
...
retinanet = torch.load('/home/maantonov_1/VKR/weights/retinanet/retinanet11_0.29138004434325043.pt', map_location=device)
