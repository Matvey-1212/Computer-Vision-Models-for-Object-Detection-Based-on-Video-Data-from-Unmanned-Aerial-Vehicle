...
batch_size = 8
num_workers = 4
weights_name = 'retinanet_oan_full_summer_lr0.0003_step_5'
path_to_save = '/home/maantonov_1/VKR/weights/retinanet/summer/04_03_2024/' + weights_name
...
train_dataset = LADD(train_df, mode = "train", season = 0, transforms = T.Compose([Augmenter(local_transform), Normalizer(), ToTorch()]))
valid_dataset = LADD(valid_df, mode = "valid", season = 0, transforms = T.Compose([Normalizer(), ToTorch()]))
