...
dali_iterator = DALIGenericIterator(
    pipelines=[get_dali_pipeline_aug_rotate(images_dir = images_dir, annotations_file = annotations_file, batch_size = 16, num_threads = 4)],
...
for i, data in enumerate(dali_iterator):
    ...
    bbox = rotate_bboxes2(bbox, angles, bb_shape)
