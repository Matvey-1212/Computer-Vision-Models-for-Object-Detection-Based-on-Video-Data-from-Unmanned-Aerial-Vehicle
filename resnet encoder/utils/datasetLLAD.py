...
class LLAD(Dataset):
    ...
    def __init__(self, dataframes_list, mode = "train", data_format='min_max',gaus = False, small_class_mask = False, class_mask = False,  transforms = None, smart_crop = False, new_shape = (640, 640)):
