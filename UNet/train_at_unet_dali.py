...
weights_name = f'{datetime.date.today().isoformat()}_at_unet_main_lr_lr{start_lr}_step{num_steps}_wce_weight{wce_weight}'
path_to_save = f'/home/maantonov_1/VKR/weights/at_unet_main/main/{datetime.date.today().isoformat()}/wce_weight{wce_weight}/'
